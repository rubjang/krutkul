...
--
-- Host: localhost
-- Generation Time: Aug 03, 2016 at 10:25 AM
...
(8, 5, 'ทดสอบตั้งกระทู้เว็บบอร์ด 2', 'ทดสอบตั้งกระทู้เว็บบอร์ด 2\r\nทดสอบตั้งกระทู้เว็บบอร์ด 2\r\nทดสอบตั้งกระทู้เว็บบอร์ด 2\r\nทดสอบตั้งกระทู้เว็บบอร์ด 2\r\nทดสอบตั้งกระทู้เว็บบอร์ด 2\r\nทดสอบตั้งกระทู้เว็บบอร์ด 2\r\nทดสอบตั้งกระทู้เว็บบอร์ด 2\r\nทดสอบตั้งกระทู้เว็บบอร์ด 2', 'admin', 'rubjang@gmail.com', '2016-08-03', 35);
...
--
ALTER TABLE `shop_webboard`
  MODIFY `id_webboard` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
