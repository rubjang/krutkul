...
if($_REQUEST[menuMessage]=="Message"){
?>
...
document.getElementById('Showdata').innerHTML="";
window.open("index.php?menuMessage=Message&id_shop="+id+"&id_menu="+id2+"&menu="+id3,"_self");
return true;
}
</script>
...
<form name="form1" method="post" action="save-menu-message.php" target="Iframs" onSubmit="return check();">
  <table width="740" border="0" cellpadding="0" cellspacing="1">
    ...
    <tr class="text13b">
      ...
      <td width="685" align="left" valign="middle" class="comment"><b><?=$r_menu[menu_shop]?></b></td>
    </tr>
    <tr>
