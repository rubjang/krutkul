...
$ok=mysql_query("Update shop_category set category='".addslashes($category)."' where id_category='$id_category'");
if($ok){
echo"<script>alert('ดำเนินการเีรียบร้อย!!');window.parent.SentOK2();</script>";
exit();
}else{
